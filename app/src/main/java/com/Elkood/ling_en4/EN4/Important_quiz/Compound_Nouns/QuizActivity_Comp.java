package com.Elkood.ling_en4.EN4.Important_quiz.Compound_Nouns;
...
public class QuizActivity_Comp extends AppCompatActivity {
    ...
    private ArrayList<Qutions_Comp> qutionsList;
    ...
    private Qutions_Comp currentQuestion;
    private int score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_comp);
        ScorePrefrence = getSharedPreferences("SaveScore", MODE_PRIVATE);
        editerScore = ScorePrefrence.edit();
        textviewQustion = findViewById(R.id.qution_comp);
        textViewscore = findViewById(R.id.text_View_score_comp);
        textViewQustionCount = findViewById(R.id.text_View_count_question_comp);
        textViewCountDown = findViewById(R.id.countDown_comp);
        RbGroup = findViewById(R.id.Radio_Group_comp);
        R1 = findViewById(R.id.radio_button1_comp);
        R2 = findViewById(R.id.radio_button2_comp);
        R3 = findViewById(R.id.radio_button3_comp);
        R4 = findViewById(R.id.radio_button4_comp);

        ConfirmNext = findViewById(R.id.confirm_next_comp);
        ...
        if (savedInstanceState == null) {
            QuizDbHelper_Comp DbHelper = new QuizDbHelper_Comp(getApplicationContext());
...
//            }
    ...
    private void finishQuiz() {
        if (ScorePrefrence.getInt("CompHighScore", 0) < score) {
            editerScore.putInt("CompHighScore", score);
            editerScore.apply();
        }
        finish();
    }

package com.Elkood.ling_en4.EN4.Important_quiz.Abbrevationss;
...
public class QuizActivity_Abberv extends AppCompatActivity {
    ...
    private ArrayList<Qutions_Abberv> qutionsList;
    ...
    private Qutions_Abberv currentQuestion;
    private int score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_abberv);
        ScorePrefrence = getSharedPreferences("SaveScore", MODE_PRIVATE);
        editerScore = ScorePrefrence.edit();
        textviewQustion = findViewById(R.id.qution_abber);
        textViewscore = findViewById(R.id.text_View_score_abber);
        textViewQustionCount = findViewById(R.id.text_View_count_question_abber);
        textViewCountDown = findViewById(R.id.countDown_abber);
        RbGroup = findViewById(R.id.Radio_Group_abber);
        R1 = findViewById(R.id.radio_button1_abber);
        R2 = findViewById(R.id.radio_button2_abber);
        R3 = findViewById(R.id.radio_button3_abber);
        R4 = findViewById(R.id.radio_button4_abber);

        ConfirmNext = findViewById(R.id.confirm_next_abber);
        ...
        if (savedInstanceState == null) {
            QuizDbHelper_Abbervsions DbHelper = new QuizDbHelper_Abbervsions(getApplicationContext());
...
/*
    ...
    private void finishQuiz() {
        if (ScorePrefrence.getInt("AbberHighScore", 0) < score) {
            editerScore.putInt("AbberHighScore", score);
            editerScore.apply();
        }
        finish();
    }

package com.Elkood.ling_en4.EN4.Important_quiz.Extinsions;
...
public class QuizActivity_Extinsons extends AppCompatActivity {

    public static final String EXTRA_SCORE = "extrascore_abber";
    private static final String KEY_SCORE = "keyscore_abber";
    private static final String KEY_QUESTION_COUNT = "keyQustionCount_abber";
    private static final String KEY_Mills_Left = "keymilsLeft_abber";
    private static final String KEY_ANSWERD = "keyanswerd_abber";
    private static final String KEY_QustionList = "keyQustionList_abber";
    ...
    private ArrayList<Qutions_Extinsoins> qutionsList;
    ...
    private Qutions_Extinsoins currentQuestion;
    private int score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_extinsions);
        ScorePrefrence = getSharedPreferences("SaveScore", MODE_PRIVATE);
        editerScore = ScorePrefrence.edit();
        textviewQustion = findViewById(R.id.qution_ext);
        textViewscore = findViewById(R.id.text_View_score_ext);
        textViewQustionCount = findViewById(R.id.text_View_count_question_ext);
        textViewCountDown = findViewById(R.id.countDown_ext);
        RbGroup = findViewById(R.id.Radio_Group_ext);
        R1 = findViewById(R.id.radio_button1_ext);
        R2 = findViewById(R.id.radio_button2_ext);
        R3 = findViewById(R.id.radio_button3_ext);
        R4 = findViewById(R.id.radio_button4_ext);

        ConfirmNext = findViewById(R.id.confirm_next_ext);
        ...
        if (savedInstanceState == null) {
            QuizDbHelper_Extinsions DbHelper = new QuizDbHelper_Extinsions(getApplicationContext());
...
/*
    ...
    private void finishQuiz() {
        if (ScorePrefrence.getInt("ExtHighScore", 0) < score) {
            editerScore.putInt("ExtHighScore", score);
            editerScore.apply();
        }
        finish();
    }

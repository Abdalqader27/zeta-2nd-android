...
public class Quiz {
    ...
    public Quiz(String quiz, int r1_check, int r2_check, int r3_check, int r4_check, String r1_text, String r2_text, String r3_text, String r4_text, ImageButton button) {
        this.quiz = quiz;
        R1_check = r1_check;
        R2_check = r2_check;
        R3_check = r3_check;
    ...
    public Quiz(String quiz, int r1_check, int r2_check, int r3_check, int r4_check, String r1_text, String r2_text, String r3_text, String r4_text) {
        this.quiz = quiz;
        R1_check = r1_check;
        R2_check = r2_check;
        R3_check = r3_check;
    ...
    public Quiz(String quiz, int r1_check, int r2_check, int r3_check, int r4_check) {
        this.quiz = quiz;
        R1_check = r1_check;
        R2_check = r2_check;
        R3_check = r3_check;

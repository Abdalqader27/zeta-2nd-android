...
import com.Elkood.ling_en4.Views.SecondYear.English_4.Courses_Quiz.R2012;
import com.Elkood.ling_en4.Views.SecondYear.English_4.Courses_Quiz.R2013;
import com.Elkood.ling_en4.Views.SecondYear.English_4.Courses_Quiz.R2014;
import com.Elkood.ling_en4.Views.SecondYear.English_4.Courses_Quiz.r2018;

import java.util.ArrayList;

public class Adapter_Courses extends RecyclerView.Adapter<Adapter_Courses.Recycle_Adapter_Schdual_View_Holder> {
    ...
    public Adapter_Courses(ArrayList<item_repeater> List, Context context) {
        this.list = List;
            ...
            if (isLongClick) {
                ...
                if (position1 == 0) {
                    ...
                    R2017_1.setOnClickListener(v -> {
                        Intent intent = new Intent(view.getContext(), com.Elkood.ling_en4.Views.SecondYear.English_4.Courses_Quiz.r2017.class);
                    ...
                    R2017_2.setOnClickListener(v -> {
                        Intent intent = new Intent(view.getContext(), com.Elkood.ling_en4.Views.SecondYear.English_4.Courses_Quiz.r2017_2.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                    ...
                    R2016_1.setOnClickListener(v -> {
                        Intent intent = new Intent(view.getContext(), com.Elkood.ling_en4.Views.SecondYear.English_4.Courses_Quiz.r2016.class);
                        view.getContext().startActivity(intent);
                    ...
                    R2016_3.setOnClickListener(v -> {
                        Intent intent = new Intent(view.getContext(), com.Elkood.ling_en4.Views.SecondYear.English_4.Courses_Quiz.R2016_3.class);
                        view.getContext().startActivity(intent);
                    ...
                    Intent intent = new Intent(view.getContext(),com.Elkood.ling_en4.Views.SecondYear.English_4.Courses_Quiz. R2015.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);

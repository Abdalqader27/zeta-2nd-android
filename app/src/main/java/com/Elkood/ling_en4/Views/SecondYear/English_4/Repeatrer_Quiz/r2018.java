...
public class r2018 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new Quiz("1. The main idea of this paragraph is ………",
                ...
                "C. streaming videos  ",
                "D. video player"));
        list.add(new Quiz("2.In line 7, the word  it  refers to the",
                0, 0, 0, 1,
                "A. memory ",
                "B. internet ",
                "C. video player ",
                "D.movie"));
        list.add(new Quiz("3.In line 5, the word buffering is similar in meaning to a/an ……",
                0, 0, 1, 0,
                "A.file storage ",
                "B. data storage  ",
                "C. temporary storage        ",
                "D. permanent storage  "));
        list.add(new Quiz("4. In line 15, the word  interruption  is closer in meaning to ……",
                1, 0, 0, 0,
                "A. disconnection  ",
                "B. interference",
                "C. interaction            ",
                "D. intervention "));
        list.add(new Quiz("5. In line 19, the word steady means ……",
                0, 1, 0, 0,
                "A. intermittent ",
                "B. stable ",
                "C. slow ",
                "D. uninterruptable"));
        list.add(new Quiz("6.It could be inferred from the text that streaming is a/an ………downloading on the net.",
                0, 0, 0, 1,
                "A. application for",
                "B. line for  ",
                "C. method for  ",
                "D. solution for"));
        list.add(new Quiz("7.According to the passage, all the following in correct EXCERT ",
                0, 0, 1, 0,
        ...
        list.add(new Quiz("17. algorithm ",
                0, 0, 1, 0,
                "A. collection of related webpages",
                "B. high capacity internet connection    ",
                "C. a formal used for compressing component of a data stream",
                "D. the main transmission path handling the major data"));
//arrived
        list.add(new Quiz("18. broadband  ",
                0, 1, 0, 0,
                "A. collection of related webpages",
                "B. high capacity internet connection    ",
                "C. a formal used for compressing component of a data stream",
                "D. the main transmission path handling the major data"));
        list.add(new Quiz("19. website ",
                1, 0, 0, 0,
                "A. collection of related webpages",
                "B. high capacity internet connection    ",
                "C. a formal used for compressing component of a data stream",
        ...
        list.add(new Quiz("27) .aero",
                0, 0, 1, 0,
                "A. Aerobic Endurance",
                "B. Animation Editor",
                "C. Aviation Industry",
                "D. Alternative Education"));
        list.add(new Quiz("28. To find a webpage , you have to click on a hyperlink or enter a URL..  ",
                1, 0, -1, -1,
                "A. True",
                "B. false",
                "",
        ...
        list.add(new Quiz("30. Different mail systems transfer emails in different ways..",
                ...
                "",
                ""));
        list.add(new Quiz("31. SMTP delivers messages one at a time.",
                0, 1, -1, -1,
                "A. True",
                "B. false",
                "",
                ""));
        list.add(new Quiz("32. To make you search for< Arsenal > more specific on google,type<football>..",
                1, 0, -1, -1,
                "A. True",
                "B. false",
                "",
        ...
        list.add(new Quiz("33. TCP only works with packet-switched networks.",
                0, 1, -1, -1,
                "A. True",
                "B. False",
                " ",
        ...
        list.add(new Quiz("34. Spam is very common.",
                ...
                "",
                ""));
        list.add(new Quiz("35. Web-based email is suitable if you work in office.",
                1, 0, -1, -1,
                "A. True",
                "B. false",
                "",
        ...
        list.add(new Quiz("37. A …… is an interface that enables dissimilar networks to communicate.",
                ...
                "C. router ",
                "D. bridge"));
        list.add(new Quiz("38. A …… is a simple computer comprising a processor and memory, display, keyboard, mouse and hard drives only.",
                1, 0, 0, 0,
                "A. Thin client ",
                "B. LAN ",
                "C. bridge ",
                "D. hub"));
        list.add(new Quiz("39. The checksum is calculated by the …… layer which also reassembles the message segments.",
                0, 1, 0, 0,
                "A. physical ",
                "B. transport ",
                "C. application",
                "D. session"));
        list.add(new Quiz("40. The encodes and sends the packet.",
                1, 0, 0, 0,
                "A. physical layer ",
                "B. transport layer",
                "C. session layer ",
        ...
        list.add(new Quiz("44. Mp3 files can provide information about itself in coded block called a …. ",
                ...
                "C. layer ",
                "D. sector  "));
        list.add(new Quiz("45. A program that rips songs from a CD and turns them into W A V file is a/an ……. ",
                0, 1, 0, 0,
                "A. recorder",
                "B. ripper  ",
                "C. encoder ",
        ...
        list.add(new Quiz("46. A….. network is linked by radio waves ",
                ...
                "C.  Wifi      ",
                "D. cable"));
        list.add(new Quiz("47. ……. Is used by server and PCs to send mail ",
                0, 0, 0, 1,
                "A.  TCP/IP             ",
                "B. IMAP",
                "C. POP   ",
        ...
        list.add(new Quiz("48. ……….. allows you to download  message headers before downloading the message ",
                ...
                "C. POP ",
                "D. ISMTP "));
        list.add(new Quiz("49. Once you… on the hyperlink , you…… for the webpage to be copied on your computer",
                1, 0, 0, 0,
                "A. have clicked / wait  ",
                "B.  clicked / waited   ",
        ...
        list.add(new Quiz("51. You cannot save the file …… you name it.",
                ...
                "C. when  ",
                "D. until "));
        list.add(new Quiz("52.If you spilled coffe on the keyboard, you … it.",
                0, 1, 0, 0,
                "A. will damage   ",
                "B. would damage  ",
                "C. would damaged   ",
        ...
        list.add(new Quiz("54..If there ……… a power cut while you were using the computer , you might lose unsaved data.  ",
                ...
                "C. were ",
                "D. has been    "));
        list.add(new Quiz("55. .Avoid …..  search function in your website as much as possible",
                1, 0, 0, 0,
                "A.using",
                "B.use",
                "C.used      ",
                "D. to use "));
        list.add(new Quiz("56.A MIDI message ….. sound into 8-bits of digital information ",
                0, 0, 0, 1,
                "A. to encode   ",
                "B. encoding  ",
                "C. encoded   ",
                "D. encodes"));
        list.add(new Quiz("57......... Ensure the machine is disconnected you repair a PC. ",
                0, 0, 1, 0,
                "A. once     ",
                "B. after  ",
                "C. before   ",
        ...
        list.add(new Quiz("58. Exercise in the morning rather than.......... ",
                ...
                "C. to smoke    ",
                "D. smokes "));
        list.add(new Quiz("59. A client is a network computer  ……. For accessing a service on server. ",
                0, 0, 0, 1,
                "A. use     ",
                "B. to use ",
                "C. using    ",
                "D. used"));
        list.add(new Quiz("60. A router is a special computer………messages when serval networks are linked ",
                0, 1, 0, 0,
                "A. to direct ",
                "B. directing ",
                "C. directed ",

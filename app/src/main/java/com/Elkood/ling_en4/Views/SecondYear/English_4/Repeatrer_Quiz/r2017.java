...
public class r2017 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new Quiz("2 ) In line 1, the pronoun “Which” refers to ………….  :  ",
                0, 0, 0, 1,
                "A. patients",
                "B. doctors",
                "C. networkers",
        ...
        list.add(new Quiz("3 ) In line 6, the word  practice is similar in meaning to a/an …… ",
                0, 0, 1, 0,
                "A. office",
                "B.net café",
                "C. clinic ",
        ...
        list.add(new Quiz("4 ) In line 9, the verb call up is closer in meaning to ……",
                1, 0, 0, 0,
                "A. display",
                "B. phone",
                "C. send",
        ...
        list.add(new Quiz("5 ) In line 16, the word  tailored software  means a/an …… package",
                0, 1, 0, 0,
                "A. a fully operational",
                "B. specific purpose",
                "C. standard",
                "D. open"));
        list.add(new Quiz("6 ) It could be inferred from the text that different people in the practice use  …………application(s)",
                0, 0, 0, 1,
                "A. the same",
                "B. different",
                "C. tailored",
                "D. B and C"));
        list.add(new Quiz("7 ) According to the passage. All the following is correct EXCEPT…………. : ",
                0, 0, 1, 0,
        ...
        list.add(new Quiz("8 ) According to the passage, which program is used to calculate the payroll?",
                1, 0, 0, 0,
                "A. Excel  ",
                "B. word ",
                "C. Access",
                "D. PowerPoint"));
        list.add(new Quiz("9 ) In line 19, the word payroll'' means ……",
                0, 0, 0, 1,
                "A. drugs ",
                "B. appointments ",
                "C. tables",
                "D. salaries"));
        list.add(new Quiz("10 ) According to the passage, doctors use databases for all the following EXCEPT…………. : .",
                0, 0, 1, 0,
                "A. patients records",
                "B. appointments",
                "C. employees’ names",
                "D. information about drugs "));
        list.add(new Quiz("11) Barcode : ",
                0, 0, 0, 1,
                "A. Engine",
                "B. Tray",
                "C. Computer",
                "D. Reader "));
        list.add(new Quiz("12) mainframe : ",
                0, 0, 1, 0,
                "A. Engine",
                "B. Tray",
                "C. Computer",
                "D. Reader "));
        list.add(new Quiz("13) System :  ",
                0, 1, 0, 0,
                "A. Engine",
                "B. Tray",
                "C. Computer",
                "D. Reader "));
        list.add(new Quiz("14) Search :  ",
                1, 0, 0, 0,
                "A. Engine",
                "B. Tray",
                "C. Computer",
        ...
        list.add(new Quiz("16) Internet address",
                0, 0, 1, 0,
                "A. set boundaries for beginning and end of a message ",
                "B. an email process in which the connection is initialized by the sending computer",
                "C. a 32-bit number identifying a node on an IP network ",
                "D. a transmission mode in which each computer takes turns sending and receiving"));
        list.add(new Quiz("17) Full-duplex",
                0, 0, 0, 1,
                "A. set boundaries for beginning and end of a message ",
                "B. an email process in which the connection is initialized by the sending computer",
                "C. a 32-bit number identifying a node on an IP network ",
                "D. a transmission mode in which each computer takes turns sending and receiving"));
        list.add(new Quiz("18) Bracketing",
                1, 0, 0, 0,
                "A. set boundaries for beginning and end of a message ",
                "B. an email process in which the connection is initialized by the sending computer",
                "C. a 32-bit number identifying a node on an IP network ",
        ...
        list.add(new Quiz("20) Algorithm",
                0, 0, 1, 0,
                "A. collection of related webpages ",
                "B. high capacity internet connection",
                "C. a formula used for compressing component of a data stream",
                "D. the main transmission path handling the major data"));
        list.add(new Quiz("21) Broadband",
                0, 1, 0, 0,
                "A. collection of related webpages ",
                "B. high capacity internet connection",
                "C. a formula used for compressing component of a data stream",
                "D. the main transmission path handling the major data"));
        list.add(new Quiz("22) Website",
                1, 0, 0, 0,
                "A. collection of related webpages ",
                "B. high capacity internet connection",
                "C. a formula used for compressing component of a data stream",
                "D. the main transmission path handling the major data"));
        list.add(new Quiz("23) IP ",
                1, 0, 0, 0,
                "A. Internet Protocol ",
                "B. Image Processing ",
                "C. Interaction Point",
                "D. Instrument Panel"));
        list.add(new Quiz("24) IRC ",
                0, 1, 0, 0,
                "A. Information Resource Center ",
                "B. Internet Relay Chat  ",
                "C. Innovation Relay Centre",
                "D. International Relations Center"));
        list.add(new Quiz("25) SMTP  ",
                0, 0, 1, 0,
        ...
        list.add(new Quiz("58. Exercise in the morning rather than……….",
                ...
                "C. to smoke ",
                " D. smokes"));
        list.add(new Quiz("59. A client is a network computer ………… for accessing a service on a server.",
                0, 0, 0, 1,
                "A. use",
                "B. to use",
                "C. using",
